...
const suggestedActions = [
    {
        ...
        label: 'reporting...',
        action: 'give me your Alignment Judgment on all the exercices of the exam',
    },
    {
        title: 'Tell me the Bloom taxonomy level',
        label: 'about exams',
        action: 'Tell me about the bloom taxonomy levels on all the exercices of the exam',
    },
];
