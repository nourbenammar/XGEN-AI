(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_04cd29._.js", {
...
;
;
// Create a simple hook to replace the missing useScrollToBottom
function useCustomScrollToBottom() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCustomScrollToBottom.useEffect": ()=>{
            scrollToBottom();
        }
    }["useCustomScrollToBottom.useEffect"], []);
    return [
...
_s(useCustomScrollToBottom, "lHQIji/5LN24QIYjY/llb+uspw4=");
// Component definitions that would normally be imported
const ChatInput = ({ question, setQuestion, onSubmit, isLoading })=>{
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    className: "bg-blue-500 text-white rounded p-2 hover:bg-blue-700 disabled:bg-gray-300",
                    children: "Send"
                }, void 0, false, {
                    fileName: "[project]/src/app/(dashboard)/Alignment_evaluation/page.jsx",
                    lineNumber: 42,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: "This is a simple chat application. Start by sending a message below!"
            }, void 0, false, {
                fileName: "[project]/src/app/(dashboard)/Alignment_evaluation/page.jsx",
                lineNumber: 81,
                columnNumber: 7
...
_c4 = Header;
const CHAT_HTTP_URL = "http://localhost:5000/chat"; // Your chat HTTP endpoint
const UPLOAD_HTTP_URL = "http://localhost:5000/upload"; // Your upload HTTP endpoint
function Chat() {
    _s1();
    const [containerRef, endRef, scrollToBottom] = useCustomScrollToBottom();
    ...
    const isWaitingForResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    async function handleSubmit(text) {
        if (isLoading || isWaitingForResponse.current) return;
        const messageText = text || question;
        if (!messageText.trim()) return;
        setIsLoading(true);
        isWaitingForResponse.current = true;
        const traceId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
        setMessages((prev)=>[
                ...prev,
                {
                    content: messageText,
        ...
        try {
            ...
            if (!response.ok) {
                ...
                setMessages((prev)=>[
                        ...prev,
                        {
                            content: `Error: ${errorData?.error || 'Failed to fetch response'}`,
                            role: "assistant",
    ...
    const uploadFile = async ()=>{
        ...
        try {
            ...
            const response = await fetch(UPLOAD_HTTP_URL, {
                method: 'POST',
                body: formData
            });
            if (!response.ok) {
                const errorData = await response.json();
                setUploadStatus(errorData?.error || 'File upload failed');
            } else {
                const data = await response.json();
                setUploadStatus(data?.message || 'File uploaded successfully');
                // Optionally clear the selected file after successful upload
                setSelectedFile(null);
                // Optionally reset the upload status after a short delay
                setTimeout(()=>setUploadStatus(""), 3000);
            }
        } catch (error) {
            console.error("Error uploading file:", error);
            setUploadStatus(error.message || 'An unexpected error occurred during upload');
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                ref: containerRef,
                children: [
                    messages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Overview, {}, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/Alignment_evaluation/page.jsx",
                        lineNumber: 188,
                        columnNumber: 35
                    }, this),
                    ...
                    (isLoading || isWaitingForResponse.current) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ThinkingMessage, {}, void 0, false, {
                        fileName: "[project]/src/app/(dashboard)/Alignment_evaluation/page.jsx",
                        lineNumber: 192,
                        columnNumber: 57
                    }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-col mx-auto px-4 bg-background pb-4 md:pb-6 gap-2 w-full md:max-w-3xl items-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChatInput, {
                            ...
                            onSubmit: handleSubmit,
                            isLoading: isLoading || isWaitingForResponse.current
                        }, void 0, false, {
                            fileName: "[project]/src/app/(dashboard)/Alignment_evaluation/page.jsx",
                            lineNumber: 197,
                            columnNumber: 11
...
_s1(Chat, "2A8xHV1MNfN11eLZnm9oqK1dd98=", false, function() {
    return [
        useCustomScrollToBottom
    ];
});
_c5 = Chat;
...
__turbopack_refresh__.register(_c3, "Overview");
__turbopack_refresh__.register(_c4, "Header");
__turbopack_refresh__.register(_c5, "Chat");
...
//# sourceMappingURL=_04cd29._.js.map