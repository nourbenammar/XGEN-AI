(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2caf26._.js", {
...
"[project]/src/app/(dashboard)/syllabus/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DashboardPage = ()=>{
    ...
    const [reportGenerated, setReportGenerated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [backendResponse, setBackendResponse] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const generateImprovedReport = async (data)=>{
        ...
        try {
            ...
            doc.text("Syllabus Improvement Report", margin, y, {
                align: "left"
            });
            y += 12;
            // Subtitle
            ...
            const summaryText = `The syllabus achieved an overall score of ${overallScore}/100. Analysis revealed ` + `${enhancement?.bloom_analysis?.missing_levels?.length || 0} missing Bloom's taxonomy levels and ` + `${enhancement?.misalignments?.length || 0} misalignments between objectives and assessments.`;
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Evaluation Scores", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Learning Outcomes Comparison", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
            // Original Outcomes
            y = addText("Original Learning Outcomes:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            ...
            y += 10;
            // Improved Outcomes
            y = addText("Improved Learning Outcomes:", margin, y, {
                fontSize: 14,
                isBold: true,
                color: [
                    128,
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Assessment Analysis", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
            // Original Assessments
            y = addText("Original Assessments:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const originalAssessments = enhancement?.original_assessments || [];
            if (originalAssessments.length === 0) {
                y = addText("No assessments provided.", margin + 5, y);
            } else {
                originalAssessments.forEach((item)=>{
                    y = addText(`${item.type} (${item.weight})`, margin + 5, y, {
                        isListItem: true
                    });
                });
            }
            ...
            y = addText("Improved Assessments:", margin, y, {
                fontSize: 14,
                isBold: true,
                color: [
                    128,
            ...
            const improvedAssessments = enhancement?.assessment_improvements || [];
            if (improvedAssessments.length === 0) {
                y = addText("No improved assessments generated.", margin + 5, y);
            } else {
                improvedAssessments.forEach((item)=>{
                    y = addText(`${item.type} (${item.weight}) - ${item.description}`, margin + 5, y, {
                        isListItem: true,
                        color: [
                            128,
                            0,
            ...
            y = addText("Missing Bloom's Levels:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const missingBloomLevels = enhancement?.missing_bloom_levels || [];
            if (missingBloomLevels.length === 0) {
                y = addText("All Bloom's levels covered.", margin + 5, y, {
                    color: [
                        40,
                        167,
                        69
                ...
                missingBloomLevels.forEach((level)=>{
                    y = addText(level, margin + 5, y, {
                        isListItem: true,
                        color: [
                            220,
                            53,
            ...
            y = addText("Coverage Explanation:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const coverageExplanation = enhancement?.coverage_explanation || "No explanation provided.";
            y = addText(coverageExplanation, margin + 5, y);
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Bloom's Taxonomy Analysis", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
            // Taxonomy Levels
            y = addText("Taxonomy Levels Coverage:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const allLevels = [
            ...
            allLevels.forEach((level)=>{
                ...
                y = addText(`${level}: ${isFound ? "Present" : "Missing"}`, margin + 5, y, {
                    fontSize: 12,
                    color: isFound ? [
                        40,
                        167,
            ...
            y = addText("Missing Levels Analysis:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const missingLevels = enhancement?.bloom_analysis?.missing_levels || [];
            if (missingLevels.length === 0) {
                y = addText("All Bloom's taxonomy levels covered.", margin + 5, y, {
                    color: [
                        40,
                        167,
                        69
                ...
                missingLevels.forEach((level)=>{
                    y = addText(`${level}: Incorporate this cognitive level for better learning outcomes.`, margin + 5, y, {
                        isListItem: true,
                        color: [
                            220,
                            53,
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Misalignments and Recommendations", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
            // Misalignments
            y = addText("Identified Misalignments:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            const misalignments = enhancement?.misalignments || [];
            if (misalignments.length === 0) {
                y = addText("No misalignments detected.", margin + 5, y, {
                    color: [
                        40,
                        167,
                        69
            ...
            y += 10;
            // Suggestions
            y = addText("Improvement Suggestions:", margin, y, {
                fontSize: 14,
                isBold: true
            });
            ...
            doc.setTextColor(128, 0, 0);
            doc.setFont("helvetica", "bold");
            y = addText("Conclusion and Next Steps", margin, y, {
                fontSize: 18,
                isBold: true
            });
            doc.setFont("helvetica", "normal");
...
Original Assessments:
${originalAssessments.length === 0 ? "No assessments provided." : originalAssessments.map((item)=>`- ${item.type} (${item.weight})`).join("\n")}

Improved Assessments:
${improvedAssessments.length === 0 ? "No improved assessments generated." : improvedAssessments.map((item)=>`- ${item.type} (${item.weight}): ${item.description}`).join("\n")}

Bloom's Taxonomy Analysis
- Found Levels: ${foundLevels.join(", ") || "N/A"}
- Missing Levels: ${missingLevels.join(", ") || "N/A"}

Missing Bloom's Levels for Assessments:
${missingBloomLevels.length === 0 ? "All levels covered." : missingBloomLevels.map((level)=>`- ${level}`).join("\n")}

Assessment Coverage Explanation:
${coverageExplanation}
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            ...
            if (data.error) {
                ...
                } else if (data.error.includes("Failed to generate valid JSON")) {
                    setError("The analysis failed due to an invalid server response. Please try uploading the file again or contact support.");
                } else {
                    setError(data.error || "An error occurred while processing the file.");
                }
                throw new Error(data.error);
            }
            // Check for fallback response indicating failure
            if (data.enhancement?.scoring?.score === 0 || data.enhancement?.bloom_analysis?.error) {
                setError(data.enhancement?.bloom_analysis?.error ? `Analysis failed: ${data.enhancement.bloom_analysis.error}. Please try again or contact support.` : "The analysis failed to generate valid results. Please try uploading the file again or contact support.");
            ...
            setError(`Failed to process the file: ${error.message}. Please try again or contact support.`);
        } finally{
            setIsLoading(false);
        }
    };
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: "How to Use the Syllabus Improvement Tool"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                            lineNumber: 535,
                                            columnNumber: 19
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "Upload your syllabus document in either PDF or DOC format. You can click the upload area to browse your files or simply drag and drop your document directly onto the designated area."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                    lineNumber: 552,
                                                    columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-gray-600 dark:text-gray-400",
                                                    children: 'Once you\'ve uploaded your syllabus, click the "Analyze Syllabus" button. Our system will process your document, extracting learning objectives, assessments, and other key components. The analysis uses advanced AI to evaluate your syllabus against best practices in curriculum design.'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                    lineNumber: 562,
                                                    columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-gray-600 dark:text-gray-400",
                                                    children: "The analysis provides:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                    lineNumber: 572,
                                                    columnNumber: 21
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                    children: "Improved Learning Outcomes"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                    lineNumber: 576,
                                                                    columnNumber: 27
                                                                }, this),
                                                                " - Rewrites your existing outcomes using best practices and Bloom's taxonomy verbs"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 576,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                    children: "Assessment Analysis"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                    lineNumber: 577,
                                                                    columnNumber: 27
                                                                }, this),
                                                                " - Evaluates and suggests improvements for assessment types"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 577,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                    children: "Bloom's Taxonomy Analysis"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                    lineNumber: 578,
                                                                    columnNumber: 27
                                                                }, this),
                                                                " - Identifies which cognitive levels are present and missing"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 578,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                    children: "Misalignments"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                    lineNumber: 579,
                                                                    columnNumber: 27
                                                                }, this),
                                                                " - Points out inconsistencies between objectives and assessments"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 579,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                ...
                                                                " - Provides numerical evaluations across multiple dimensions"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 580,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Use action verbs from Bloom's taxonomy for learning outcomes"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 601,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Ensure alignment between learning objectives and assessment methods"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 602,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Include a variety of cognitive levels in your learning objectives"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 603,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Make objectives measurable and specific"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 604,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Create clear connections between course content and assessments"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                            lineNumber: 605,
                                                            columnNumber: 23
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Upload your syllabus for AI-powered analysis and get actionable recommendations"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                    lineNumber: 628,
                                    columnNumber: 13
                            ...
                            children: [
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                ...
                                                children: "Syllabus Analysis Tool"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                lineNumber: 636,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Upload your syllabus in PDF or DOC format for comprehensive evaluation and improvement suggestions"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                lineNumber: 639,
                                                columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        !reportGenerated ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        ...
                                                        children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    ...
                                                                                    children: "Drop your syllabus here or click to browse"
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                    lineNumber: 685,
                                                                                    columnNumber: 31
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    ...
                                                                                    children: "Supports PDF, DOC, or DOCX files"
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                    lineNumber: 688,
                                                                                    columnNumber: 31
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                id: "file-upload-help",
                                                                className: "sr-only",
                                                                children: "Upload a PDF or DOC file containing your syllabus"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                lineNumber: 703,
                                                                columnNumber: 23
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                children: "Analyzing Your Syllabus..."
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                lineNumber: 718,
                                                                columnNumber: 25
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                                            ...
                                                                            children: "Syllabus Improvement Report"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                            lineNumber: 730,
                                                                            columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: [
                                                                        "Your syllabus received an overall score of ",
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                                            children: [
                                                                                backendResponse?.enhancement?.scoring?.score || "N/A",
                                                                                "/100"
                                                                        ...
                                                                        ".",
                                                                        backendResponse?.enhancement?.bloom_analysis?.missing_levels?.length > 0 ? ` We identified ${backendResponse?.enhancement?.bloom_analysis?.missing_levels?.length} missing Bloom's taxonomy levels` : " Your syllabus has excellent Bloom's taxonomy coverage",
                                                                        backendResponse?.enhancement?.misalignments?.length > 0 ? ` and ${backendResponse?.enhancement?.misalignments?.length} misalignments between objectives and assessments.` : " and good alignment between objectives and assessments.",
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                                            className: "text-md font-semibold mb-2 text-gray-800 dark:text-gray-200",
                                                                            children: "Original Learning Outcomes"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                            lineNumber: 810,
                                                                            columnNumber: 25
                                                                        }, this),
                                                                        backendResponse?.syllabus?.content?.objectives?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-sm text-gray-500 dark:text-gray-400",
                                                                            children: "No objectives provided in the syllabus."
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                            lineNumber: 814,
                                                                            columnNumber: 27
                                                                            ...
                                                                            children: backendResponse?.syllabus?.content?.objectives?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                    className: "mb-1",
                                                                                    children: item
                                                                                }, index, false, {
                                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        backendResponse?.enhancement?.improved_outcomes?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-sm text-gray-500 dark:text-gray-400",
                                                                            children: "No improved outcomes generated."
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                            lineNumber: 830,
                                                                            columnNumber: 27
                                                                            ...
                                                                            className: "list-disc pl-5 text-sm text-gray-700 dark:text-gray-300",
                                                                            children: backendResponse?.enhancement?.improved_outcomes?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                    className: "mb-1",
                                                                                    children: item
                                                                                }, index, false, {
                                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tooltip"], {
                                                                                    children: [
                                                                                        ...
                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipContent"], {
                                                                                            children: "Review original and improved assessments, including Bloom's level coverage."
                                                                                        }, void 0, false, {
                                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                            lineNumber: 849,
                                                                                            columnNumber: 29
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        ...
                                                                                        children: "Original Assessments"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 859,
                                                                                        columnNumber: 29
                                                                                    }, this),
                                                                                    backendResponse?.enhancement?.original_assessments?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-gray-500 dark:text-gray-400 mt-1",
                                                                                        children: "No assessments provided."
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 863,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        children: backendResponse?.enhancement?.original_assessments?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                                className: "p-2",
                                                                                                children: [
                                                                                                    item.type,
                                                                                                    " (",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        className: "text-lg font-semibold text-gray-800 dark:text-gray-200",
                                                                                        children: "Improved Assessments"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 878,
                                                                                        columnNumber: 29
                                                                                    }, this),
                                                                                    backendResponse?.enhancement?.assessment_improvements?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-gray-500 dark:text-gray-400 mt-1",
                                                                                        children: "No improved assessments generated."
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 882,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        className: "list-disc pl-5 text-base text-gray-700 dark:text-gray-300 mt-2 space-y-1",
                                                                                        children: backendResponse?.enhancement?.assessment_improvements?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        className: "text-lg font-semibold text-gray-800 dark:text-gray-200",
                                                                                        children: "Missing Bloom's Levels"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 897,
                                                                                        columnNumber: 29
                                                                                    }, this),
                                                                                    backendResponse?.enhancement?.missing_bloom_levels?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-green-600 dark:text-green-400 mt-1",
                                                                                        children: "All Bloom's levels covered in assessments!"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 901,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        className: "list-disc pl-5 text-base text-gray-700 dark:text-gray-300 mt-2 space-y-1",
                                                                                        children: backendResponse?.enhancement?.missing_bloom_levels?.map((level, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                                className: "p-2 bg-red-50 dark:bg-red-900/20 rounded",
                                                                                                children: level
                                                                                            }, index, false, {
                                                                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-gray-700 dark:text-gray-300 mt-2",
                                                                                        children: backendResponse?.enhancement?.coverage_explanation || "No explanation provided."
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 917,
                                                                                        columnNumber: 29
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tooltip"], {
                                                                                    children: [
                                                                                        ...
                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipContent"], {
                                                                                            children: "Analysis of cognitive levels covered in the syllabus objectives."
                                                                                        }, void 0, false, {
                                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                            lineNumber: 931,
                                                                                            columnNumber: 29
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        className: "text-lg font-semibold text-gray-800 dark:text-gray-200",
                                                                                        children: "Taxonomy Levels Coverage"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 941,
                                                                                        columnNumber: 29
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        className: "text-lg font-semibold text-gray-800 dark:text-gray-200",
                                                                                        children: "Missing Levels"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 967,
                                                                                        columnNumber: 29
                                                                                    }, this),
                                                                                    backendResponse?.enhancement?.bloom_analysis?.missing_levels?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-green-600 dark:text-green-400 mt-1",
                                                                                        children: "No missing levels - excellent coverage!"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 971,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        children: backendResponse?.enhancement?.bloom_analysis?.missing_levels?.map((level, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                className: "text-base bg-red-50 dark:bg-red-900/20 p-2 rounded border-l-2 border-red-500",
                                                                                                children: [
                                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                    ...
                                                                                                    " This cognitive level should be incorporated for comprehensive learning outcomes."
                                                                                                ]
                                                                                            }, index, true, {
                                                                                                fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                                lineNumber: 977,
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                                        className: "text-lg font-semibold text-gray-800 dark:text-gray-200",
                                                                                        children: "Identified Misalignments"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 1000,
                                                                                        columnNumber: 29
                                                                                    }, this),
                                                                                    backendResponse?.enhancement?.misalignments?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-green-600 dark:text-green-400 mt-1",
                                                                                        children: "No misalignments detected - excellent alignment between objectives and assessments!"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 1004,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        className: "list-disc pl-5 text-base text-gray-700 dark:text-gray-300 mt-2 space-y-1",
                                                                                        children: backendResponse?.enhancement?.misalignments?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    ...
                                                                                    backendResponse?.enhancement?.suggestions?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                        className: "text-base text-gray-500 dark:text-gray-400 mt-1",
                                                                                        children: "No additional suggestions provided."
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                        lineNumber: 1021,
                                                                                        columnNumber: 31
                                                                                        ...
                                                                                        children: backendResponse?.enhancement?.suggestions?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    children: "Analyze Another Syllabus"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                    lineNumber: 1059,
                                                                    columnNumber: 23
...
_s(DashboardPage, "ecjvVnO8EtZwik3MYoKA7JpWWpA=");
_c = DashboardPage;
...
"[project]/src/app/(dashboard)/syllabus/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_2caf26._.js.map