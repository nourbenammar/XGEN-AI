    ...
    const generateImprovedReport = async (data)=>{
        ...
        try {
            ...
            if (missingLevels.length === 0) {
                ...
                missingLevels.forEach((item)=>{
                    const level = typeof item === 'string' ? item : item.level;
                    const reason = typeof item === 'string' ? 'Incorporate this cognitive level for better learning outcomes.' : item.reason;
                    const impact = typeof item === 'string' ? 'Limits comprehensive learning outcomes.' : item.impact;
                    const recommendation = typeof item === 'string' ? 'Add objectives using appropriate action verbs.' : item.recommendation;
                    ...
                    y = addText(`Reason: ${reason}`, margin + 10, y, {
                        fontSize: 10,
                        color: [
                            0,
                            0,
                    ...
                    y = addText(`Impact: ${impact}`, margin + 10, y, {
                        fontSize: 10,
                        color: [
                            0,
                            0,
                    ...
                    y = addText(`Recommendation: ${recommendation}`, margin + 10, y, {
                        fontSize: 10,
                        color: [
                            0,
                            0,
            ...
            if (misalignments.length === 0) {
                ...
                misalignments.forEach((item)=>{
                    const misalignmentText = `Description: ${item.description}\nSeverity: ${item.severity}\nRecommendation: ${item.recommendation}`;
                    y = addText(misalignmentText, margin + 5, y, {
                        isListItem: true
                    });
                });
            }
            ...
            if (suggestions.length === 0) {
                ...
                suggestions.forEach((item, index)=>{
                    const suggestionText = `${item.suggestion} (${item.category}, Impact: ${item.impact})`;
                    y = addText(`${index + 1}. ${suggestionText}`, margin + 5, y, {
                        color: [
                            0,
                            100,
                            0
            ...
            const missingLevelsText = missingLevels.length === 0 ? "All Bloom's taxonomy levels covered." : missingLevels.map((item)=>{
                const level = typeof item === 'string' ? item : item.level;
                const reason = typeof item === 'string' ? 'Incorporate this cognitive level for better learning outcomes.' : item.reason;
                const impact = typeof item === 'string' ? 'Limits comprehensive learning outcomes.' : item.impact;
                const recommendation = typeof item === 'string' ? 'Add objectives using appropriate action verbs.' : item.recommendation;
...
Misalignments:
${misalignments.length === 0 ? "No misalignments detected." : misalignments.map((item)=>`- ${item.description} (Severity: ${item.severity}, Recommendation: ${item.recommendation})`).join("\n")}

Suggestions:
${suggestions.length === 0 ? "No suggestions provided." : suggestions.map((item)=>`- ${item.suggestion} (${item.category}, Impact: ${item.impact})`).join("\n")}
      `;
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                            className: `flex items-center p-3 rounded-lg border ${isFound ? 'bg-green-50 dark:bg-green-900/20 border-green-500' : 'bg-red-50 dark:bg-red-900/20 border-red-500'}`,
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                    className: "flex-1",
                                                                                                    children: [
                                                                                                        ...
                                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                            className: `ml-2 text-sm ${isFound ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`,
                                                                                                            children: isFound ? 'Present' : 'Missing'
                                                                                                        }, void 0, false, {
                                                                                                            fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                                            lineNumber: 825,
                                                                                                            columnNumber: 37
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            children: [
                                                                                ...
                                                                                backendResponse?.enhancement?.bloom_analysis?.missing_levels?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    ...
                                                                                    children: backendResponse?.enhancement?.bloom_analysis?.missing_levels?.map((item, index)=>{
                                                                                        const level = typeof item === 'string' ? item : item.level;
                                                                                        const reason = typeof item === 'string' ? 'This cognitive level should be incorporated for comprehensive learning outcomes.' : item.reason;
                                                                                        const impact = typeof item === 'string' ? 'Limits comprehensive learning outcomes.' : item.impact;
                                                                                        const recommendation = typeof item === 'string' ? 'Add objectives using appropriate action verbs.' : item.recommendation;
                                                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                            ...
                                                                                            children: [
                                                                                                ...
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                    className: "ml-4 text-sm text-gray-700 dark:text-gray-300 space-y-1",
                                                                                                    children: [
                                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                                            children: [
                                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                            ...
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                    ...
                                                                                                    children: [
                                                                                                        ...
                                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                            className: `text-sm font-medium px-2 py-1 rounded-full ${item.severity === 'High' ? 'bg-red-500 text-white' : item.severity === 'Medium' ? 'bg-yellow-500 text-black' : 'bg-green-500 text-white'}`,
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                backendResponse?.enhancement?.suggestions?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    ...
                                                                                    children: backendResponse?.enhancement?.suggestions?.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                            className: "flex items-start p-3 bg-green-50 dark:bg-green-900/10 rounded-lg",
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                    className: "bg-green-600 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center mr-3 flex-shrink-0",
                                                                                                    children: index + 1
                                                                                                }, void 0, false, {
                                                                                                    fileName: "[project]/src/app/(dashboard)/syllabus/page.jsx",
                                                                                                    lineNumber: 934,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b18579._.js.map