...
"[project]/src/app/(dashboard)/teacher/course-generator/upload/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UploadSyllabusPage() {
    ...
    const handleUpload = async ()=>{
        ...
        try {
            setIsUploading(true);
            setError(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["courseGeneratorAPI"].uploadSyllabus(file);
    ...
    const handleGenerate = async ()=>{
        ...
        try {
            ...
            setError(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["courseGeneratorAPI"].generateCourse(uploadResult.file_id);
...
"[project]/src/app/(dashboard)/teacher/course-generator/upload/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_b487c5._.js.map